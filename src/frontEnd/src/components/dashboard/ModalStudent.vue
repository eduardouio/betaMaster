...
onMounted(() => {
    const modal = document.getElementById('StudenModal');
    modal.showModal();
...
<template>
    <div>
        <dialog id="StudenModal" class="modal">
            <div class="modal-box w-6/12 max-w-5xl">
                <h3 class="font-bold text-lg bg-slate-100 rounded-lg p-1 text-center border">Eduardo Vinicio Villota Montenegro</h3>
  ...
  <iframe src="https://www.google.com/maps/@-0.1923873,-78.4865596,15z" class="w-full h-50"></iframe>
