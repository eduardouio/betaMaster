...
async function loadData() { 
    ...
    let url = serverConfigData.urls.studentData.replace(
        '{idUser}', props.idStudent
    );
    ...
    if (response.status != 200){
        ...
        store.commit('setStudentData', await response.json());
        studentData = await store.state.studentData;
...
<template>
  <transition name="fade" class="my-trans">
  <div class="my-modal">
    <LoaderVue v-if="showLoader" />
    <dialog v-else class="modal" open>
      <div class="modal-box w-6/12 max-w-5xl">
        <h3 class="font-bold text-lg bg-slate-100 rounded-lg p-1 text-center border">
        </h3>
          ...
          <div class="flex flex-col px-6">
            ...
            <div class="flex h-8 flex-row">
              ...
              <a href="https://github.com/EgoistDeveloper/" target="_blank">
                <h2 class="text-lg font-semibold">Colegio Mayor de Litoral </h2>
              </a>
            </div>
            ...
            <div class="my-2 flex flex-row space-x-2">
              ...
              <div class="flex flex-row">
                ...
                <div class="hover:text-cyan-800">3ro de bachillerarto</div>
              </div>
              ...
              <div class="flex flex-row">
                ...
                <div class="text-xs text-gray-400/80 hover:text-gray-400">babahyi</div>
              </div>
        ...
        <div class="modal-action">
          <form method="dialog">
            <button 
              class="btn btn-sm btn-error btn-outline hover:text-white"
