...
<template>
    <a 
    :href="url" 
    :title="'Ver perfil en ' + icon"
    target="_blank" 
    v-html="iconsTypes[icon]"
    class="pl-1 hover:transform hover:scale-110"
    ></a>
</template>