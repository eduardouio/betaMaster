      ...
      <div class="bg-white shadow-none sm:shadow-lg px-8 sm:px-12 w-full xs:w-full sm:w-8/12 md:w-7/12 lg:w-6/12 xl:w-2/6 h-screen sm:h-auto py-8 rounded-xl">
        ...
        ></div>
          <div class="flex flex-col gap-4 px-0 py-4">
            ...
            <div class="my-2 flex flex-row justify-center" v-if="false">
              <span class="absolute bg-white px-4">Iniciar Sesion con</span>
              <div
                class="w-full bg-gray-200 mt-3" style="height: 1px"
              ></div>
            </div>
            <div class="w-full flex flex-col gap-2" v-if="false">
              ...
              <button class="bg-blue-500 text-white w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-blue-700 duration-100 ease-in-out">
              ...
              <button class="bg-cyan-500 text-white w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-gray-800 duration-100 ease-in-out">
